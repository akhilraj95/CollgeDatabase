...
def submit(request):
    try:
        if request.method == "POST":
            ...
            ticket.active = False
            ticket.save()
            return HttpResponse("You are done. The college details will be reflected on our website. For further changes call support. Your cannot use the same link to upload data again.")
    except:
        return HttpResponse("The data submited couldn't be uploaded.")
